...
<form class="dat-hang-online-form" action="{{URL::to('/save-product')}}" method="post" id="baiviet-dat-hang-online-form" accept-charset="UTF-8" enctype="multipart/form-data">
@csrf	
...
<td><div class="form-item form-type-textfield form-item-sanpham-item-1-price">
 <input class="auto price form-text" placeholder="Đơn giá" type="text" id="edit-sanpham-item-1-price" name="product_price" value="{{$v_content->product_price}}" size="60" maxlength="128" />
</div>
...
<a rel="4" href="javascript:void(0);" class="them-moi">+ Thêm sản phẩm</a>
