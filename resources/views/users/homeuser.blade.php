...
<head profile="http://www.w3.org/1999/xhtml/vocab">
  <title>Trang tổng hợp | HTKK360 LOGISTICS</title>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<link rel="shortcut icon" href="public/frontend/images/48icon.ico" type="image/vnd.microsoft.icon" />
...
<meta name="original-source" content="https://www.thuongdo.com" />
		<script type="text/javascript">var uid_in_page = 252532;</script>
...
<body class="html not-front logged-in no-sidebars page-dashboard dashboard-page " >
  <div class="olay-css" style="display: none;"></div>
    <header class="dashboard-header block-clear block-both">
	    <div class="logo"><a href="https://truon.com/laravel/htkk360pj" class="shiner" rel="nofollow"><img src="public/frontend/images/htkklogo.png" alt= "Nhập hàng Trung Quốc - HTKK360 LOGISTICS" title = "Nhập hàng Trung Quốc - HTKK360 LOGISTICS" width= 150px/></a></div>
	...
	<div class="dashboard-info">
        ...
        <ul>
            ...
            <li class="thong-tin notify item cart-inner">
                                <a href="javascript:void(0);" class="top name" data-total="0" data-intro="Xin chào <b>@if (Auth::check())
                                                                                                                        {{Auth::user()->name}}
                                                                                                                        @endif
                                                                                                                    </b>, Hôm nay bạn có <b>0</b> thông báo mới" data-position="bottom" >
            ...
            <li class="avatar item logout-li front-li">
                <a href="" class="top"><img src="public/frontend/images/no-avatar.jpg" /></a>
			    <i class="fa fa-angle-down" aria-hidden="true"></i>
                <div class="logout-inner">
					<i class="fa fa-caret-up" aria-hidden="true"></i>
					<div class="content">
						<p class="no-border">
                            <a href="/thong-tin-ca-nhan"><span><img width="30" height="30" src="public/frontend/images/no-avatar.jpg" /></span>
                                            @if (Auth::check())
                                            <b>
                                            {{Auth::user()->name}}
                                           </b><br />
                                           <strong class="kcode">Mã KH: {{Auth::user()->id}}</strong></a>
                                           @endif                                      
						</p>
						<p class="children">
							<a href="/don-hang/kien-hang"><b class="fa fa-th"></b> Kiện hàng</a>                            <a href="/don-hang/gop-y"><b class="fa fa-commenting"></b> Góp ý</a>							<a href="/thanh-vien/mat-khau"><b class="fa fa-unlock-alt"></b> Thay đổi mật khẩu</a>							<a href="{{URL::to('/dang-xuat')}}"><b class="fa fa-sign-out"></b> Thoát</a>						</p>
					</div>
				</div>
            </li>
        </ul>
...
<div class="main-dashboard block-both">
	...
	<ul>
		<li class="parent">
            ...
            <ul>
                <li><a href="{{URL::to('/don-hang-tao')}}">Tạo đơn hàng</a></li>
                <li><a href="/dat-hang/nha-cung-cap">Từ sản phẩm đã mua</a></li>
                <li><a href="/kien-ky-gui">Tạo đơn ký gửi</a></li>
            </ul>
		</li>
		<li class="parent">
            ...
            <ul>
                <li><a href="/don-hang">Tất cả đơn hàng</a></li>
                <li><a href="/don-hang/ky-gui">Tất cả đơn ký gửi</a></li>
            </ul>
		</li>
		<li class="parent">
		...
		<li class="parent last">
            ...
            <ul>@if (Auth::check())
                <li><a href="{{URL::to('/edit-user-'.Auth::user()->id)}}">Thông tin cá nhân</a></li>
        ...
        <div class="content-dashboard-top block-both">
            <div class="content-dashboard-top-inner">
                ...
                <div class="tim-kiem-search-form">
                    <form class="tim-kiem-add-form" target="_blank" action="https://s.taobao.com/search" method="post" id="baiviet-tim-kiem-add-form" accept-charset="UTF-8"><div><div class="search-text">
                       <span>
                        
                       </span>
<div class="form-item form-type-textfield form-item-keyword">
 <input disabled placeholder="Ấn vào nút tìm kiếm để chuyển hướng..." type="text" id="edit-keyword" name="keyword" value="" size="60" maxlength="128" class="form-text form-autocomplete" /><input type="hidden" id="edit-keyword-autocomplete" value="" disabled="disabled" class="autocomplete" />
</div>
</div><input type="submit" id="edit-submit" name="op" value="Tìm kiếm" class="form-submit" /><input type="hidden" name="form_build_id" value="form-2VaBvVxq6GCKVa_zsNecUEY5QUE9lFjh1LJtbXvwTFw" />
<input type="hidden" name="form_token" value="Y9eaYCLAPkp7H59F4DHJ971mJwzhTiUlFcrfO6nCyGI" />
<input type="hidden" name="form_id" value="baiviet_tim_kiem_add_form" />
</div></form>                    <b>(Nếu bạn chưa tìm thấy sản phẩm mong muốn vui lòng <a href="https://www.messenger.com/" target="_bank" rel="nofollow">Click vào đây</a> gửi yêu cầu từ khóa)</b>
                </div>
                <div class="ti-gia">
					<span class="dashboard-icon"></span>
					<span class="text">
    ...
    <span class="avatar">
        ...
        <img width="100" height="100" src="public/frontend/images/no-avatar.jpg" />
...
<p class="info-edit">
@if (Auth::check())
	<a href="{{URL::to('/edit-user-'.Auth::user()->id)}}" class="edit">Chỉnh sửa thông tin</a>
@endif
</p>
...
<script type="text/javascript" src="https://www.thuongdo.com/sites/all/modules/developer/thuongdo_vidientu/js/thuongdo_vidientu.js?s18gps"></script>
            ...
            <script type="text/javascript">
                function loadJsAsync(t,n){var a=document.createElement("script");a.type="text/javascript",a.src=t,a.addEventListener("load",function(t){n(null,t)},!1),document.getElementsByTagName("body")[0].appendChild(a)}window.onload=(t=>{loadJsAsync("https://api.chatbiz.io/js/CsChat.js",function(){loadCsChat("https://realtime-v2.chatbiz.io/get-view-chat?domain=thuongdo_thuongdo&fullname=Vũ Văn Trường&phone=0974874625")})});
            </script>
        <!-- End of widget script -->
        <a href="https://zalo.me/" target="_blank" class="zalo-page">
    <img src="public/frontend/images/zalo-logo.png"/> 
  </a>
	<script>
    ...
    <!--
                  ...
                  <div class="td-thongbao">
                      ...
                      <div class="td-thongbao-content">
                         <div class="td-content-main">
                            <strong>Tài khoản của quý khách chưa cấu hình mặc định loại vận chuyển</strong><br/>
                            <p>Vui lòng chọn loại vận chuyển và xác nhận</p>
                            <form class="loai-van-chuyen-add-form">
                                <div class="form-item">
                                    <label>Cài đặt mặc định: </label>
                                    <span><input type="radio" name="rds-vc" value="1"/> Nhanh</span>
                                    <span><input type="radio" name="rds-vc" value="2"/> Thường</span>
                                </div>
                                <button class="btn-submit">Xác nhận</button>
                                <h6><a href="/bang-gia-ky-gui-hang" target="_blank"><i class="fa fa-question-circle-o" aria-hidden="true"></i> Xem chi tiết chính sách vận chuyển</a></h6>
                            </form>
                            <em>(Hoặc có thể vào thay đổi mặc định vận chuyển <b>Cài đặt -> Thông tin cá nhân</b>)</em>
                         </div>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function($) {
                ...
                $("form.loai-van-chuyen-add-form button.btn-submit").click(function() {
                   var count = 0;
                   $("form.loai-van-chuyen-add-form .form-item input").each(function() {
                      if($(this).is(":checked")) {
                         count = $(this).val();
                      }
                   });
                   if(count > 0) {
                     ...
                     $.ajax({
                        type: 'POST',
                        url: '/thong-tin-ca-nhan/loai-van-chuyen/change',
                        data: {
                            loai_vc: count
                        },
                        dataType: 'JSON',
                      ...
                      alert('Vui lòng chọn loại vận chuyển');
                   }
                   return false; 
                });
            });
