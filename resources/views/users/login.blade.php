...
@import url("https://www.thuongdo.com/sites/all/modules/contrib/ctools/css/modal.css?s18gps");
@import url("https://www.thuongdo.com/sites/all/modules/contrib/gauth/gauth_login/gauth_login.css?s18gps");
@import url("https://www.thuongdo.com/sites/all/themes/giaodiennguoidung/css/responsive-modal.css?s18gps");
</style>
<style type="text/css" media="all">
...
<body class="html not-front not-logged-in no-sidebars page-user  " >
  <div class="olay-css" style="display: none;"></div>
    <div class="container">
    <div class="left-user">
    	            <div class="logo"><a href="{{URL::to('/trang-chu')}}" class="shiner" rel="nofollow"><img src="public/frontend/images/htkklogo.png" alt= "Nhập hàng Trung Quốc - HTKK360 LOGISTICS" title = "Nhập hàng Trung Quốc - HTKK360 LOGISTICS" width=64%/></a></div>
    ...
    <div class="top">
			<h1>Đăng nhập</h1>
			<h2><a href="{{URL::to('/dang-ky')}}">Tạo tài khoản</a></h2>
    </div>
        <form class="user-login-form" action="{{route('users.login')}}" method="post" id="user-login" accept-charset="UTF-8">
        @csrf  
 ...
 <input tabindex="1" placeholder="Email" type="text" id="edit-name" name="email" value="" size="60" maxlength="60" class="form-text required" /> <span class="field-suffix"><i class="fa fa-user-circle"></i></span>
</div>
<div class="form-item form-type-password form-item-pass">
 ...
 <input tabindex="1" placeholder="Mật khẩu..." type="password" id="edit-pass" name="password" size="60" maxlength="128" class="form-text required" /> <span class="field-suffix"><i class="fa fa-lock"></i></span>
</div>
<input type="hidden" name="form_build_id" value="form-s2ZQdihiUOgNUkTms9LHZOMvWLUbt7n98OZ2B6QPC_w" />
<input type="hidden" name="form_id" value="user_login" />
<div class="form-actions form-wrapper" id="edit-actions"><input tabindex="1" type="submit" id="edit-submit" name="op" value="Đăng nhập" class="form-submit" /></div><div class="form-item form-type-checkbox form-item-remember-me">
 <input tabindex="1" type="checkbox" id="remember" name="remember" value="remember" checked="checked" class="form-checkbox" />  <label class="option" for="edit-remember-me">Duy trì đăng nhập </label>

</div>
<a href="{{URL('/quen-mat-khau')}}" class="forgot-password">Quên mật khẩu ?</a><div class="login-use-social">
                                                    <div class="btn-login btn-facebook">
                                                      <i class="fa fa-facebook" aria-hidden="true"></i>
                                                      <a href="{{URL::to('/login-facebook')}}"><span>Đăng nhập bằng Facebook</span></a>
                                                    </div>
                                                ...
                                                </div><input type="submit" id="edit-submit-google" name="op" value="" class="form-submit" /></div></form>    </div>
...
<script type="text/javascript" src="https://www.thuongdo.com/sites/all/modules/contrib/ctools/js/modal.js?s18gps"></script>
