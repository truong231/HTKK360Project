...
<div class="breadcrumb"><div class="container"><a href="/">Trang chủ</a><i class="fa fa-angle-right" aria-hidden="true"></i>Báo giá vận chuyển hàng Quảng Châu</div></div>    <div class="container">
            ...
            <div class="group-content">
                <h1 class="title-page">Bảng giá vận chuyển Quảng Châu về Việt Nam</h1>
			...
			<table class="uk-table uk-table-hover uk-table-striped uk-table-condensed">
				...
				<tbody>
					<tr>
						<td><span data-href="phivanchuyen" class="ky-gui-anchor">1. Phí vận chuyển</span></td>
						<td>Là chi phí để chuyển hàng từ kho của Thương Đô tại Trung Quốc về Việt Nam</td>
						<td class="uk-text-center uk-text-success"><i class="fa fa-check tick"></i></td>
						<td></td>
					</tr>
					<tr>
						<td><span data-href="phishiptq" class="ky-gui-anchor">2. Phí ship Trung Quốc</span></td>
						<td>Phí chuyển hàng từ nhà cung cấp tới kho của Thương Đô tại Trung Quốc</td>
						<td></td>
						<td class="uk-text-center uk-text-success"><i class="fa fa-check tick"></i></td>
					</tr>
					<tr>
						<td><span data-href="phikiemdem" class="ky-gui-anchor">3. Phí kiểm đếm</span></td>
						<td>Dịch vụ đảm bảo sản phẩm của khách không bị nhà cung cấp giao sai hoặc thiếu</td>
						<td></td>
						<td class="uk-text-center uk-text-success"><i class="fa fa-check tick"></i></td>
					</tr>
					<tr>
						<td><span data-href="phidonggo" class="ky-gui-anchor">4. Phí đóng gỗ</span></td>
						<td>Hình thức đảm bảo an toàn, hạn chế rủi ro đối với hàng dễ vỡ, dễ biến dạng</td>
						<td></td>
						<td class="uk-text-center uk-text-success"><i class="fa fa-check tick"></i></td>
					</tr>
					<tr>
						<td><span data-href="phibaohiem" class="ky-gui-anchor">5. Phí bảo hiểm</span></td>
						<td>Là dịch vụ đảm bảo hàng hóa cho khách và chịu trách nhiệm khi xảy ra rủi ro về hàng hóa và được áp dụng với những đơn hàng có mức giá từ 30 tệ/ 1 sản phẩm trở lên</td>
						<td></td>
						<td class="uk-text-center uk-text-success"><i class="fa fa-check tick"></i></td>
					</tr>
					<tr>
						<td>6. Phí ship tận nhà</td>
		...
		<div class="uk-alert uk-alert-danger"><i class="fa fa-exclamation-triangle"></i> Lưu ý: Những phí thuộc hình thức  (*) là phí bắt buộc, còn lại là tùy chọn, quý khách có thể chọn sử dụng hoặc không</div>
	</div><div id="bang-gia-phi-van-chuyen" class="bang-gia-item">
				<h2 id="phivanchuyen">4. Phí vận chuyển quốc tế</br><span style="font-size: 15px;color: red;">(Thay đổi bảng giá mới được áp dụng cho các kiện hàng xuất kho Trung Quốc về Việt Nam từ ngày 28/03/2022)</span></h2>
				...
				<table class="uk-table uk-table-hover uk-table-striped uk-table-condensed" style="text-align:center;">
					...
					<tr>
                				...
                				<td>> 30 → 100kg</td>
                				<td>38,000<sup>đ</sup></td>
                                <td>40,000<sup>đ</sup></td>
                			  </tr><tr>
                				<td>> 20 → 30kg</td>
                				<td>39,000<sup>đ</sup></td>
                                <td>41,000<sup>đ</sup></td>
                			  </tr><tr>
                				<td>> 10 → 20kg</td>
                				<td>40,000<sup>đ</sup></td>
                                <td>42,000<sup>đ</sup></td>
                			  </tr><tr>
                				<td>0 → 10kg</td>
                				<td>44,000<sup>đ</sup></td>
                                <td>47,000<sup>đ</sup></td>
                                ...
                                <td>4,500,000<sup>đ</sup></td>
                			  </tr><tr>
                				<td>> 5 → 10m3</td>
                				<td>4,400,000<sup>đ</sup></td>
                                <td>4,800,000<sup>đ</sup></td>
                			  </tr><tr>
                				<td>≤ 5m3</td>
                				<td>4,600,000<sup>đ</sup></td>
			...
			<ol type="a">
				...
				<div>
					<div><i> - Mọi mặt hàng đều có cân nặng thực tế và cân nặng quy đổi.</i></div>
					<div><i> - Đối với những mặt hàng cồng kềnh thì khối lượng đơn hàng sẽ được tính bằng công thức quy đổi.</i></div>
					<div><i> - Khối lượng quy đổi được tính theo công thức:</i> <b>Chiều dài * chiều rộng * chiều cao / 6000 = Cân nặng đơn hàng </b></div>
					<div><i> - Cân nặng được áp dụng là mức cân nặng cao hơn của trọng lượng thực và khối lượng quy đổi.</i></div>
				</div>
                    ...
                    <div class="chu-thich">
                       ...
                       <thead>
                           <tr>
                              ...
                              <th>Phí dịch vụ<br/>(Giá trị hàng hóa)</th>
                              <th>Hà Nội</th>
                              <th>Hồ Chí Minh</th>
                              <th>Hải Phòng</th>
                           </tr>
                       ...
                       <tbody>
                          <tr>
                                        ...
                                        <td colspan="5" style="text-align: left;background: #185493;color: white;">Khối lượng (m3)</td> 
                                     </tr><tr>
                                            <td>> 20m3</td>
                                            <td>0.5%</td>
                                            <td>900.000<sup>đ</sup></td>
                                            <td>1.400.000<sup>đ</sup></td>
                                            <td>1.150.000<sup>đ</sup></td>
                                         </tr><tr>
                                            <td>> 10 -> 20m3</td>
                                            <td>1%</td>
	...
	<div id="bang-gia-phi-dong-go" class="bang-gia-item">
	...
	<div id="bang-gia-phi-dong-go" class="bang-gia-item">
			<h2 id="phibaohiem">5. Phí bảo hiểm</h2>
			<table class="uk-table uk-table-hover uk-table-striped uk-table-condensed">
				<thead>
					<tr>
						<th></th>
				...
				<tbody>
					<tr>
						<td>Phí bảo hiểm</td>
						<td> = 5% giá trị đơn hàng</td>
					</tr>
				</tbody>
			</table>
		</div>
	<div class="uk-alert uk-alert-danger">
			<b>Quy định về dịch vụ hàng ký gửi từ Trung Quốc về Việt Nam:</b>
			<div>Thương Đô Logistics nhận vận chuyển tất cả các mặt hàng từ Trung Quốc về Việt Nam ngoài các sản phẩm sau đây:</div>
			<ol>
				...
				<li>Vũ khí đạn dược, trang thiết bị kỹ thuật quân sự. ( súng , đao , kiếm , dao kéo.... )</li>
				<li>Các loại văn hóa phẩm đồi trụy, phản động, Vật phẩm, ấn phẩm, tài liệu nhằm phá hoại trật tự công cộng chống lại Nhà nước Cộng hòa Xã hội Chủ nghĩa Việt Nam.</li>
		...
		</div><div class="uk-text-center"><span class="hailong">" Nỗ lực hết mình vì sự hài lòng của khách hàng !"</span></div>    
            </div>
